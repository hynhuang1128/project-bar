...
#define BLE_NVID_DEVICE_SSID                 0x9c
#define BLE_NVID_DEVICE_SSID_LEN             SSID_LEN
...
#define PESK_DOUBLESEG_IMPERIAL_MAX          497
#define PESK_DOUBLESEG_IMPERIAL_MIN          258
...
// Posture data filter
#define POSTURE_VALIDATE_COUNT               2
                                               
// Authorization status
#ifdef ENCRYPTION_FUNC  
#define AUTHEN_NONVERIFIED                   0
#define AUTHEN_VERIFIED                      1
#define AUTHEN_VERIFYING                     2
#define AUTHEN_HASH_TIMECOUNT                15
#endif
...
#define AUTOMOVE_MODE_0                      0x01
#define AUTOMOVE_MODE_1                      0x02
#define AUTOMOVE_MODE_2                      0x04
                                               
#define AUTOMOVE_HIGHEST_BIT                 0x10
#define AUTOMOVE_MODE_BITS                   0xf0
                                             
#define BLE_NVID_USERID                      0xe0
#define BLE_NVID_USERID_LEN                  17
...
#ifdef ENCRYPTION_FUNC
typedef char *(*verifyCBack_t) ( char *sourceData );
  
typedef struct AuthenData
{
  uint8 authenStatus;
  char hashCode_Token[SIMPLEPROFILE_CHAR9_LEN];
  char hashCode_Chip[SIMPLEPROFILE_CHAR9_LEN];
  char hashCode_Get[SIMPLEPROFILE_CHAR9_LEN];
  char *sourceDataInternal;
  char *sourceDataExternal;
  verifyCBack_t hashAlgorithm;
} authenData_t;
#endif
...
typedef struct
{
  ...
  uint32 timeLasting;
  uint32 timeDestination;
  uint32 previousMultiply;
  uint8 userID[SIMPLEPROFILE_CHARD_LEN];
} autoMove_t;
